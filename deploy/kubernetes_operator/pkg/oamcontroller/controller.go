...
// FLAppReconciler reconciles a ContainerizedWorkload object
type FLAppReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *FLAppReconciler) SetupWithManager(mgr ctrl.Manager) error {
